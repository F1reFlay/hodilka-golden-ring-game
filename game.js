...
const boardRoute = {
    ...
    "12": { "x": 257, "y": 426, "type": "gold", "text": "Сергиев Посад\nЖемчужина Золотого кольца, славится своим духовным сердцем — величественной Троице-Сергиевой лаврой. Именно здесь можно проследить всю историю русского православия. Духовный подъем дает вам право сделать еще один ход!" },
    ...
    "18": { "x": 374, "y": 347, "type": "gold", "text": "Переславль-Залесский\nДревний город, хранит память о рождении великого русского полководца Александра Невского. На живописном берегу Плещеева озера можно увидеть знаменитый Синь-камень, а в местном музее хранится ботик Петра I!" },
...
Object.assign(boardRoute, {
    ...
    "28": { "x": 472, "y": 108, "type": "gold", "text": "Ярославль\nОснован легендарным князем Ярославом Мудрым, включен в список Всемирного наследия ЮНЕСКО. Набережная Волги, украшенная ажурными беседками, предлагает идеальную прогулку мимо Спасо-Преображенского монастыря." },
