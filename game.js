...
const quizDatabase = {
    "Москва": { q: "В каком веке была основана Москва князем Юрием Долгоруким?", a: ["В XII веке", "В X веке", "В XIV веке"], right: 0, hint: "Москва впервые упоминается в летописях в 1147 году, когда Юрий Долгорукий пригласил своего союзника фразой 'Приди ко мне, брате, в Москов'." },
    "Сергиев Посад": { q: "Какая великая православная обитель находится в Сергиевом Посаде?", a: ["Троице-Сергиева лавра", "Киево-Печерская лавра", "Александро-Невская лавра"], right: 0, hint: "Троице-Сергиева лавра — крупнейший мужской монастырь Русской православной церкви с многовековой историей, основанный Сергием Радонежским." },
    "Переславль-Залесский": { q: "Какое известное озеро находится в Переславле-Залесском?", a: ["Байкал", "Плещеево озеро", "Ладожское озеро"], right: 1, hint: "На берегах Плещеева озера Петр I построил свою знаменитую потешную флотилию, положившую начало русскому военному флоту." },
    "Ростов Великий": { q: "Каким уникальным искусством росписи по эмали славится Ростов?", a: ["Гжель", "Финифть", "Хохлома"], right: 1, hint: "Ростовская финифть — уникальный русский народный художественный промысел, миниатюрная живопись на огнеупорной эмали." },
    "Ярославль": { q: "Какой великий князь основал город Ярославль?", a: ["Ярослав Мудрый", "Владимир Мономах", "Юрий Долгорукий"], right: 0, hint: "Город назван в честь князя Ярослава Мудрого, который по легенде победил священного медведя местных язычников." },
    "Кострома": { q: "Какая сказочная героиня официально считается символом Костромы?", a: ["Баба Яга", "Снегурочка", "Русалочка"], right: 1, hint: "Кострома официально признана родиной Снегурочки, здесь расположена ее интерактивная сказочная Терем-резиденция." },
    "Иваново": { q: "Какое промышленное прозвище исторически носит город Иваново?", a: ["Город машиностроителей", "Ситцевый край (город невест)", "Оружейная столица"], right: 1, hint: "Иваново прославилось на всю страну развитой текстильной промышленностью, фабриками тканей и производством ярких ситцев." },
    "Суздаль": { q: "Что запрещено строить в Суздале, чтобы сохранить его древний облик?", a: ["Деревянные дома", "Высотные здания", "Каменные церкви"], right: 1, hint: "В Суздале действует строгий закон охраны наследия, запрещающий строить здания выше трех этажей, чтобы не портить исторический ландшафт." },
    "Владимир": { q: "Каменные ворота какого цвета являются главным символом древнего Владимира?", a: ["Красные ворота", "Золотые ворота", "Серебряные ворота"], right: 1, hint: "Золотые ворота Владимира — уникальный памятник древнерусской фортификационной архитектуры XII века, построенный при князе Андрее Боголюбском." },
    "Гусь-Хрустальный": { q: "Династия каких знаменитых промышленников основала этот город мастеров?", a: ["Мальцовы", "Демидовы", "Строгановы"], right: 0, hint: "Гусь-Хрустальный прославился как столица стеклоделия, где в здании Георгиевского собора по проекту Бенуа с мозаиками Васнецова размещается Музей хрусталя." }
};
