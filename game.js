...
const gameRulesText = "ПРАВИЛА ИГРЫ «Золотое кольцо России»\n\n1. Поставьте все фишки игроков на поле «Москва».\n2. Бросайте кубик и передвигайте фишки по «шагам»-кружочкам столько, какое число выпало на кубике сверху.\n3. В случае попадания фишки на «стрелку», в следующий ход двигайте фишку по указанному направлению.\n4. Если фишка оказалась в «болоте», игрок пропускает ход.\n5. Если фишка попала на оранжевые «шаги»-кружочки (золотые города), игрок получает дополнительный ход.\n6. Обратный ход запрещен.\n7. На каждом ходу отвечайте на вопросы викторины по теме городов. За верный ответ начисляется 10 баллов!\n8. Побеждает тот, кто наберет наибольшее количество баллов к моменту финиша!";
...
const boardRoute = {
    ...
    "12": { "x": 218, "y": 362, "type": "gold", "isBonus": true, "city": "Сергиев Посад", "text": "Сергиев Посад — Жемчужина Золотого кольца, славится своим духовным сердцем — величественной Троице-Сергиевой лаврой. Духовный подъем дает вам право сделать еще один ход!" },
    ...
    "18": { "x": 318, "y": 295, "type": "gold", "isBonus": true, "city": "Переславль-Залесский", "text": "Переславль-Залесский — Древний город, хранит память о рождении Александра Невского. На берегу Плещеева озера хранится ботик Петра I! Вы получаете дополнительный ход." },
    ...
    "23": { "x": 368, "y": 197, "type": "gold", "isBonus": true, "city": "Ростов Великий", "text": "Ростов Великий — Славится своим величественным Кремлем с уникальными звонами белокаменных стен. Погрузиться в историю поможет посещение музеев финифти. Вы получаете дополнительный ход." },
...
Object.assign(boardRoute, {
    ...
    "28": { "x": 401, "y": 92, "type": "gold", "isBonus": true, "city": "Ярославль", "text": "Ярославль — Основан легендарным князем Ярославом Мудрым, включен в список Всемирного наследия ЮНЕСКО. Волжская набережная предлагает идеальную прогулку и дополнительный ход!" },
    ...
    "36": { "x": 563, "y": 75, "type": "gold", "isBonus": true, "city": "Кострома", "text": "Кострома — Ровесница Москвы, основанная Юрием Долгоруким, уникально сохранила веерную планировку центральных улиц. Сделайте еще один ход!" },
    "37": { "x": 551, "y": 55, "type": "normal", "city": "Иваново" },
    "38": { "x": 546, "y": 33, "type": "normal", "city": "Иваново" },
    "39": { "x": 553, "y": 14, "type": "gold", "isBonus": true, "city": "Иваново", "text": "Иваново — Знаменитый «город невест» и «ситцевый край» хранит уникальную промышленную архитектуру конструктивизма. Вы получаете дополнительный ход." },
    ...
    "49": { "x": 724, "y": 166, "type": "gold", "isBonus": true, "city": "Суздаль", "text": "Суздаль — Эталон русского градостроительного ансамбля. Город-музей под открытым небом, сохраняющий древний облик Кремля. Получите дополнительный ход!" },
...
// ==========================================
Object.assign(boardRoute, {
    "56": { "x": 567, "y": 235, "type": "gold", "isBonus": true, "city": "Владимир", "text": "Владимир — Древняя столица Северо-Восточной Руси, основанная в X века, хранит белокаменные шедевры домонгольского зодчества — Золотые ворота и Успенский собор. Сделайте дополнительный ход!" },
    ...
    "61": { "x": 498, "y": 340, "type": "gold", "isBonus": true, "city": "Владимир", "text": "Углич — Хранитель драматических страниц истории, приковывает внимание Кремлем на берегу великой реки Волги. Вам начислен дополнительный ход." },
    "62": { "x": 496, "y": 366, "type": "normal", "city": "Владимир" },
    "63": { "x": 493, "y": 394, "type": "gold", "isBonus": true, "city": "Владимир", "text": "Плёс — Маленький живописный город, пейзажи которого вдохновляли великого русского художника Исаака Левитана. Сделайте еще один ход!" },
    ...
    "68": { "x": 541, "y": 499, "type": "gold", "isBonus": true, "city": "Владимир", "text": "Юрьев-Польский — Основан Юрием Долгоруким. Георгиевский собор знаменит своей удивительной древней каменной резьбой. Бонусный ход ваш!" },
    ...
    "90": { "x": 131, "y": 94, "type": "gold", "isBonus": true, "city": "Переславль-Залесский", "text": "Александров — Бывшая опричная столица Ивана Грозного. Здесь вершилась история Российского государства. Сделайте еще один ход!" },
    ...
    "106": { "x": 510, "y": 170, "type": "gold", "isBonus": true, "city": "Ростов Великий", "text": "Муром — Родина былинного богатыря Ильи Муромца и святых Петра и Февронии. Сделайте дополнительный ход!" },
    ...
    "117": { "x": 768, "y": 278, "type": "gold", "isBonus": true, "city": "Кострома", "text": "Рязань — Древний рязанский Кремль и старинные улочки. Родина великого русского поэта Сергея Есенина. Вы получаете дополнительный ход." },
...
Object.assign(quizDatabase, {
    "Кострома": {
        q: "Какое культовое сооружение Костромы является колыбелью царской династии Романовых?",
        a: ["Свято-Троицкий Ипатьевский монастырь", "Богоявленско-Анастасиин монастырь", "Церковь Воскресения на Дебре"],
        right: 0,
        hint: "Именно в Свято-Троицком Ипатьевском монастыре в марте 1613 года юный Михаил Федорович Романов был призван на престол Земским собором, что положило конец Смутному времени."
    },
    "Иваново": {
        q: "В каком архитектурном стиле, ставшем символом советского авангарда, построены знаменитые здания 'Дом-корабль' и 'Дом-подкова' в Иваново?",
        a: ["Конструктивизм", "Сталинский ампир", "Модерн"],
        right: 0,
        hint: "Иваново — настоящая столица красного конструктивизма. В 1920-1930-е годы здесь возводились уникальные здания-утюги, корабли и подковы, отражавшие дух новой советской эпохи."
    },
    "Суздаль": {
        q: "Какой уникальный объект, объединивший памятники деревянного зодчества со всей Владимирской области, расположен на берегу реки Каменки?",
        a: ["Музей деревянного зодчества и крестьянского быта", "Щурово городище", "Суздальский Посад"],
        right: 0,
        hint: "В Музей деревянного зодчества под открытым небом были перевезены уцелевшие старинные храмы, избы, амбары и ветряные мельницы XVIII-XIX веков, воссоздающие облик сибирской и центральной русской деревни."
    },
    "Владимир": {
        q: "Рельефным изображением какого библейского царя-псалмопевца украшена центральная глава белокаменного Дмитриевского собора во Владимире?",
        a: ["Царь Давид", "Царь Соломон", "Царь Саул"],
        right: 0,
        hint: "Дмитриевский собор XII века знаменит своей уникальной 'каменной сказкой' — на его стенах высечено около 1500 рельефов, а в центре композиций неизменно восседает царь Давид, поющий хвалу Богу."
    },
    "Гусь-Хрустальный": {
        q: "Какое грандиозное здание, построенное по проекту архитектора Леонтия Бенуа и украшенное полотном Виктора Васнецова, стало главным залом Музея хрусталя?",
        a: ["Георгиевский собор", "Никольский храм", "Мальцовский дворец"],
        right: 0,
        hint: "Георгиевский собор — шедевр неорусского стиля. Его возвели на средства промышленника Юрия Мальцова, а интерьер украшало гигантское полотно Виктора Васнецова 'Страшный суд', уцелевшее до наших дней."
    }
});
...
function startGame(totalPlayers, hasBots) {
    ...
    document.getElementById("gold-modal-text").textContent = "Москва — сердце и столица России, а также главная отправная точка нашего великого путешествия! Именно отсюда берет свое начало легендарный туристический маршрут 'Золотое кольцо России', объединяющий древние города Северо-Восточной Руси с их уникальной историей, великой культурой и многовековыми традициями.";
