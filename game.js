...
const boardRoute = {
    ...
    "8": { "x": 154, "y": 417, "type": "normal", "city": "Москва" },
    "9": { "x": 171, "y": 400, "type": "normal", "city": "Москва" },
    "10": { "x": 188, "y": 390, "type": "normal", "city": "Москва" },
    "11": { "x": 204, "y": 380, "type": "normal", "city": "Москва" },
    ...
    "13": { "x": 219, "y": 340, "type": "normal", "city": "Сергиев Посад" },
    "14": { "x": 231, "y": 323, "type": "fork", "city": "Сергиев Посад" },
    "15": { "x": 253, "y": 319, "type": "normal", "city": "Сергиев Посад" },
    "16": { "x": 277, "y": 313, "type": "normal", "city": "Сергиев Посад" },
    "17": { "x": 301, "y": 307, "type": "normal", "city": "Сергиев Посад" },
    ...
    "19": { "x": 325, "y": 273, "type": "normal", "city": "Переславль-Залесский" },
    "20": { "x": 335, "y": 254, "type": "normal", "city": "Переславль-Залесский" },
    "21": { "x": 342, "y": 234, "type": "normal", "city": "Переславль-Залесский" },
    "22": { "x": 356, "y": 218, "type": "normal", "city": "Переславль-Залесский" },
    ...
    "24": { "x": 381, "y": 179, "type": "normal", "city": "Ростов Великий" },
    "25": { "x": 399, "y": 167, "type": "fork", "city": "Ростов Великий" }
};
...
Object.assign(boardRoute, {
    "26": { "x": 422, "y": 133, "type": "normal", "city": "Ростов Великий" },
    "27": { "x": 411, "y": 111, "type": "normal", "city": "Ростов Великий" },
    ...
    "29": { "x": 420, "y": 77, "type": "normal", "city": "Ярославль" },
    "30": { "x": 447, "y": 71, "type": "normal", "city": "Ярославль" },
    "31": { "x": 475, "y": 74, "type": "normal", "city": "Ярославль" },
    "32": { "x": 504, "y": 74, "type": "normal", "city": "Ярославль" },
    "33": { "x": 529, "y": 93, "type": "normal", "city": "Ярославль" },
    "34": { "x": 547, "y": 111, "type": "normal", "city": "Ярославль" },
    "35": { "x": 568, "y": 99, "type": "normal", "city": "Ярославль" },
    ...
    "37": { "x": 551, "y": 55, "type": "normal", "city": "Кострома" },
    "38": { "x": 546, "y": 33, "type": "normal", "city": "Кострома" },
    ...
    "40": { "x": 587, "y": 26, "type": "normal", "city": "Иваново" },
    "41": { "x": 618, "y": 34, "type": "normal", "city": "Иваново" },
    "42": { "x": 647, "y": 33, "type": "normal", "city": "Иваново" },
    "43": { "x": 680, "y": 36, "type": "normal", "city": "Иваново" },
    "44": { "x": 709, "y": 47, "type": "normal", "city": "Иваново" },
    "45": { "x": 724, "y": 65, "type": "normal", "city": "Иваново" },
    "46": { "x": 733, "y": 91, "type": "normal", "city": "Иваново" },
    "47": { "x": 735, "y": 116, "type": "normal", "city": "Иваново" },
    "48": { "x": 734, "y": 140, "type": "normal", "city": "Иваново" },
...
// ==========================================
// ГЕЙМ ЧАСТЬ 3: ФИНАЛ КАРТЫ И ШКОЛЬНАЯ ВИКТОРИНА
// ==========================================
Object.assign(boardRoute, {
    ...
    "69": { "x": 512, "y": 491, "type": "normal", "city": "Владимир" },
    "70": { "x": 489, "y": 479, "type": "normal", "city": "Владимир" },
    "71": { "x": 464, "y": 466, "type": "normal", "city": "Владимир" },
    "72": { "x": 443, "y": 458, "type": "normal", "city": "Владимир" },
    "73": { "x": 424, "y": 447, "type": "normal", "city": "Владимир" },
    "74": { "x": 400, "y": 449, "type": "normal", "city": "Владимир" },
    "75": { "x": 369, "y": 451, "type": "normal", "city": "Владимир" },
    "76": { "x": 343, "y": 456, "type": "normal", "city": "Владимир" },
    "77": { "x": 315, "y": 470, "type": "normal", "city": "Владимир" },
    "78": { "x": 282, "y": 485, "type": "normal", "city": "Владимир" }, 
...
// ИСПРАВЛЕНО: Добавлен блок Москвы для старта игры
const quizDatabase = {
    "Москва": { q: "В каком веке была основана Москва князем Юрием Долгоруким?", a: ["В XII веке", "В X веке", "В XIV веке"], right: 0 },
    ...
    "Suздаль": { q: "Что запрещено строить в Суздале, чтобы сохранить его древний облик?", a: ["Деревянные дома", "Высотные здания", "Каменные церкви"], right: 1 },
...
// ==========================================
// ГЕЙМ ЧАСТЬ 4: ЛОББИ И ОБНОВЛЕНИЕ ПУТЕВОДИТЕЛЯ
// ==========================================
...
function startGame(totalPlayers, hasBots) {
    ...
    for (let i = 0; i < totalPlayers; i++) {
        ...
        players.push({
            ...
            score: 0,
            lastOpenedCity: "Москва" // ИСПРАВЛЕНО: Запоминаем последний открытый город для умных вопросов
        });
    }
...
function checkCellEffect(player) {
    ...
    if (cell) {
        // Если фишка зашла в город, обновляем её персональный последний посещенный регион!
        if (cell.city) {
...
function launchQuiz(player) {
    // ИСПРАВЛЕНО: Вопросы выбираются строго по теме последнего посещенного города этой фишки!
    const targetCity = player.lastOpenedCity ? player.lastOpenedCity : "Москва";
    const qData = quizDatabase[targetCity];
    
    if (!player.isBot) {
        document.getElementById("quiz-modal-question").textContent = `Город темы: ${targetCity}\n\n${qData.q}`;
