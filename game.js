...
// ==========================================
Object.assign(boardRoute, {
    "56": { "x": 567, "y": 235, "type": "gold", "isBonus": true, "text": "Владимир\nДревняя столица Руси, хранит белокаменные шедевры домонгольского зодчества — Золотые ворота и Успенский собор. Сделайте дополнительный ход!" },
    ...
    "106": { "x": 510, "y": 170, "type": "gold", "isBonus": true, "text": "Муром\nРодина былинного богатыря Ильи Муромца и святых Петра и Февронии. Богатырское здоровье дарит вам дополнительный ход!" },
    ...
    "117": { "x": 768, "y": 278, "type": "gold", "isBonus": true, "text": "Рязань\nДревний рязанский Кремль и старинные улочки. Родина великого поэта Сергея Есенина. Вы получаете дополнительный ход." },
