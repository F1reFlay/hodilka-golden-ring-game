...
const boardRoute = {
    ...
    "18": { "x": 318, "y": 295, "type": "gold", "text": "Переславль-Залесский\nДревний город, хранит память о рождении Александра Невского. На берегу Плещеева озера хранится ботик Петра I!" },
    "19": { "x": 325, "y": 273, "type": "normal" },
    "20": { "x": 335, "y": 254, "type": "normal" },
    "21": { "x": 342, "y": 234, "type": "normal" },
    "22": { "x": 356, "y": 218, "type": "normal" },
    "23": { "x": 368, "y": 197, "type": "gold", "text": "Ростов Великий\nСлавится своим величественным Кремлем с уникальными звонами белокаменных стен. Погрузиться в историю поможет посещение музеев финифти." },
...
Object.assign(boardRoute, {
    ...
    "28": { "x": 401, "y": 92, "type": "gold", "text": "Ярославль\nОснован легендарным князем Ярославом Мудрым, включен в список Всемирного наследия ЮНЕСКО. Волжская набережная предлагает идеальную прогулку." },
    ...
    "36": { "x": 563, "y": 75, "type": "gold", "text": "Кострома\nРовесница Москвы, основанная Юрием Долгоруким, уникально сохранила веерную планировку центральных улиц." },
    "37": { "x": 551, "y": 55, "type": "normal" },
    "38": { "x": 546, "y": 33, "type": "normal" },
    "39": { "x": 553, "y": 14, "type": "gold", "text": "Иваново\nЗнаменитый «город невест» и «ситцевый край» хранит уникальную промышленную архитектуру конструктивизма." },
    ...
    "49": { "x": 724, "y": 166, "type": "gold", "text": "Суздаль\nЭталон русского градостроительного ансамбля. Город-музей под открытым небом, сохраняющий древний облик Кремля." },
...
// ==========================================
// ГЕЙМ ЧАСТЬ 3: ФИНАЛ КАРТЫ И ЛОГИКА РАЗВИЛОК
// ==========================================
Object.assign(boardRoute, {
    "56": { "x": 567, "y": 235, "type": "gold", "text": "Владимир\nДревняя столица Руси, хранит белокаменные шедевры домонгольского зодчества — Золотые ворота и Успенский собор." },
    "57": { "x": 547, "y": 250, "type": "normal" },
    "58": { "x": 526, "y": 268, "type": "normal" },
    "59": { "x": 508, "y": 286, "type": "normal" },
    "60": { "x": 502, "y": 309, "type": "normal" },
    "61": { "x": 498, "y": 340, "type": "gold", "text": "Углич\nХранитель драматических страниц истории, приковывает внимание Кремлем на берегу великой реки Волги." },
    "62": { "x": 496, "y": 366, "type": "normal" },
    "63": { "x": 493, "y": 394, "type": "gold", "text": "Плёс\nМаленький живописный город, пейзажи которого вдохновляли великого русского художника Исаака Левитана." },
    "64": { "x": 502, "y": 413, "type": "normal" },
    "65": { "x": 510, "y": 434, "type": "normal" },
    "66": { "x": 520, "y": 456, "type": "normal" },
    "67": { "x": 531, "y": 476, "type": "normal" },
    "68": { "x": 541, "y": 499, "type": "gold", "text": "Юрьев-Польский\nОснован Юрием Долгоруким. Георгиевский собор знаменит своей удивительной древней каменной резьбой." },
    ...
    "117": { "x": 768, "y": 278, "type": "gold", "text": "Рязань\nДревний рязанский Кремль и старинные улочки. Родина великого поэта Сергея Есенина." },
